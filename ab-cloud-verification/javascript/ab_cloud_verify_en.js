// ==============================================================================
// AB-Cloud Verification Suite — JavaScript/Node.js (English)
// ==============================================================================
// English-only version. For bilingual, use ab_cloud_verify.js
// ==============================================================================
...
// --- Load zeros (streaming, handles .gz) -------------------------------------
...
async function abCloudVerifyEn(options = {}) {
...
module.exports = { abCloudVerifyEn, loadZeros, objection1, objection2, objection3, MSG_EN };
